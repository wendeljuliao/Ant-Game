...
export default class Pacman {
  ...
  #loadPacmanImages() {
    ...
    pacmanImage1.src = "images/formigatopzeraSS1.png";

    const pacmanImage2 = new Image();
    pacmanImage2.src = "images/formigatopzeraSS2.png";

    const pacmanImage3 = new Image();
    pacmanImage3.src = "images/formigatopzeraSS3.png";

    const pacmanImage4 = new Image();
    pacmanImage4.src = "images/formigatopzeraSS4.png";
